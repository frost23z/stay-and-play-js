    ...
    class i {
        constructor(t, e) {
            ...
            ;((this.className = s.className || 'datepicker'),
                ...
                (this.defaultViewDate = s.defaultViewDate || !1),
                ...
                (this.submitButtonName =
                    this.submitButton && s.submitButtonName ? s.submitButtonName : ''),
        ...
        getDefaultTime() {
            let t = this.defaultViewDate ? new Date(this.defaultViewDate.getTime()) : new Date()
            return (
                this.startDate &&
        ...
        init() {
            ;((this.parent = this.container ? this.container : this.input.parentElement),
                ...
                this.defaultViewDate &&
                    'string' == typeof this.defaultViewDate &&
        ...
        addListeners() {
            const t = this.datepicker.getElementsByClassName(
                this.className + '__month-button--next'
            )
            for (let e = 0; e < t.length; e++)
                t[e].addEventListener('click', (t) => this.goToNextMonth(t))
            const e = this.datepicker.getElementsByClassName(
                this.className + '__month-button--prev'
            )
            for (let t = 0; t < e.length; t++)
                e[t].addEventListener('click', (t) => this.goToPreviousMonth(t))
            ;(this.addBoundedListener(this.input, 'click', (t) => this.openDatepicker(t)),
                ...
                this.inline ||
                    (this.justEsc ||
                        this.addBoundedListener(this.input, 'focus', (t) => this.openDatepicker(t)),
                    (this.justEsc = !1)),
                window.addEventListener('keydown', (t) => this.doKeyDown(t)),
                document.addEventListener('focus', (t) => this.checkOnFocus(t), !0),
                this.closeOnScroll &&
                    window.addEventListener('scroll', (t) => this.closeDatepicker(t)))
        }
        generateId() {
        ...
        createDatepickerDomString() {
            ...
            ;(this.showTopbar &&
                ...
                this.inline ||
                    (t += ' ' + this.className + this.className + '--topbar-has-close-button'),
        ...
        createMonthDomString(t) {
            ...
            for (let t = 0; t < 6; t++) {
                let s = !0
                for (let a = 0; a < 7; a++) {
                    let i = e['monday' === this.startOfWeek ? 7 * t + a + 1 : 7 * t + a]
                    if (i && 'nextMonth' !== i.type) {
                        s = !1
                        break
                    }
                }
                ...
                for (let s = 0; s < 7; s++) {
                    ...
                    let n = ''
                    ;(this.hasClass(i, this.className + '__month-day--no-checkin') &&
                        (n = this.i18n['checkin-disabled']),
                    ...
                    ;(n && (o.title = n),
                        (o.role = 'button'),
                        this.getDateString(i.time) === this.getDateString(new Date()) &&
                            (o.tabindex = '0'))
                    let l = ''
        ...
        closeDatepicker() {
            ...
            ;(this.removeClass(this.datepicker, this.className + '--open'),
                ...
                (this.isOpen = !1))
            const t = new CustomEvent('afterClose', { bubbles: !0, cancelable: !0 })
            ;(this.input.dispatchEvent(t), this.removeAllBoundedListeners(document, 'click'))
        }
        autoclose() {
            this.autoClose &&
                this.changed &&
        ...
        getDayClasses(t) {
            const e = this.getDateString(t.time) === this.getDateString(new Date()),
                ...
                i =
                    this.defaultViewDate &&
                    this.getDateString(t.time) === this.getDateString(this.defaultViewDate),
                h = this.daysWithExtraText.indexOf(this.getDateString(t.time)) > -1
            let n = !1,
                o = !1,
                l = !1,
                r = !1,
            ...
            if (t.valid || 'visibleMonth' === t.type) {
                ...
                if (this.disabledDates.length > 0) {
                    ...
                    if (
                        ...
                        s[0] &&
                            s[1] &&
                            this.compareDay(t.date, s[0]) &&
                            this.countDays(s[0], s[1]) - 2 > 0)
                    ) {
                        const e = this.countDays(s[1], t.date) - 1,
                            a = this.countDays(t.date, s[0]) - 1
                        ;(((this.selectForward && e < this.minDays) ||
                            (!this.selectForward && e < this.minDays && a < this.minDays)) &&
                            (t.valid = !1),
                ...
                ;(this.disabledDaysOfWeek.length > 0 &&
                    ...
                    this.noCheckOutDaysOfWeek.length > 0 &&
                        this.noCheckOutDaysOfWeek.indexOf(s.format(t.time, 'dddd')) > -1 &&
                        (l = !0))
            }
            return [
                ...
                i ? this.className + '__month-day--default-view-date' : '',
                n ? this.className + '__month-day--disabled' : '',
                n && this.enableCheckout && 1 === this.isFirstDisabledDate
                    ? this.className + '__month-day--checkout-enabled'
                    : '',
                c ? this.className + '__month-day--before-disabled-date' : '',
                a || d ? this.className + '__month-day--checkin-only' : '',
                o ? this.className + '__month-day--no-checkin' : '',
                l ? this.className + '__month-day--no-checkout' : '',
                r ? this.className + '__month-day--day-of-week-disabled' : '',
                h ? this.className + '__month-day--with-extra' : '',
            ]
        }
        ...
        checkAndSetDefaultValue() {
            ...
            if (s && s.length >= 2) {
                const e = this.format
                ;((this.changed = !1),
                    this.setDateRange(this.parseDate(s[0], e), this.parseDate(s[1], e), t),
                    (this.changed = !0))
            } else if (this.showTopbar) {
                if (
                    ((this.datepicker.getElementsByClassName(
                        this.className + '__info--selected'
        ...
        setDateRange(t, e) {
            ...
            if (
                ...
                const t = this.defaultViewDate ? this.getDefaultTime() : this.startDate
                return (
                    this.showMonth(t, 1),
                    this.showMonth(this.getNextMonth(t), 2),
                    this.setDayIndexes(),
            ...
            for (let e = 0; e < t.length; e++) {
                ...
                (this.start &&
                    ...
                    this.getDateString(this.start, 'YYYY-MM-DD') ===
                        this.getDateString(s, 'YYYY-MM-DD'))
                    ...
                    this.getDateString(this.start, 'YYYY-MM-DD') ===
                        ...
                        : this.removeClass(
                              t[e],
                              this.className + '__month-day--first-day-selected'
                          ),
                    this.end &&
        ...
        showSelectedInfo() {
            ...
            if (
                ...
                ;((a.style.display = ''),
                    ...
                    this.inline
                        ? this.submitButton &&
                          ((n.disabled = !1), n.setAttribute('aria-disabled', 'false'))
                ...
                this.inline || !1 !== this.start || !1 !== this.end
                    ? this.inline
                        ? this.submitButton &&
                          ((n.disabled = !0), n.setAttribute('aria-disabled', 'true'))
        ...
        dayClicked(t) {
            ...
            if (e) {
                ...
                if (this.start > s && this.hasClass(t, this.className + '__month-day--no-checkin'))
                    return
                const e = this.datepicker.querySelectorAll('td[time="' + this.start + '"]')[0]
                if (
                    e &&
                    this.hasClass(e, this.className + '__month-day--no-checkout') &&
                    this.start > s
                )
                    return
                if (this.hasClass(t, this.className + '__month-day--no-checkout') && s > this.start)
                    return
            }
            if (
        ...
        isValidDate(t) {
            if (
                ((t = parseInt(t, 10)),
                (this.startDate && this.compareDay(t, this.startDate) < 0) ||
                    (this.endDate && this.compareDay(t, this.endDate) > 0))
            )
                return !1
            if (this.start && !this.end) {
                if (
                    ...
                    (this.minDays > 0 &&
                        this.countDays(t, this.start) > 1 &&
                        this.countDays(t, this.start) < this.minDays)
                )
                    return !1
                if (this.minNightsMultiple && (this.countDays(t, this.start) - 1) % 7 != 0)
                    return !1
        ...
        checkSelection() {
            const t = this.countDays(this.end, this.start),
                e =
                    !!this.showTopbar &&
                    this.datepicker.getElementsByClassName(this.className + '__info--feedback')[0]
            if (this.maxDays && t > this.maxDays) {
                ...
                this.start || this.end
                    ? this.showTopbar &&
                      ...
                      this.removeClass(e, this.className + '__info--help'))
                    : this.showTopbar &&
                      (this.removeClass(e, this.className + '__info--error'),
        ...
        goToNextMonth(t) {
            ...
            return (
                ...
                !(
                    (!this.isSingleMonth() && !a && this.compareMonth(i, this.month2) >= 0) ||
        ...
        isMonthOutOfRange(t) {
            ...
            return !!(
                (this.startDate &&
                    new Date(e.getFullYear(), e.getMonth() + 1, 0, 23, 59, 59) < this.startDate) ||
        ...
        disableNextPrevButtons() {
            ...
            ;(s > 1 && 89 !== s && !this.moveBothMonths
                ...
                this.isMonthOutOfRange(this.getPrevMonth(this.month1))
                    ? (this.addClass(i[0], this.className + '__month-button--disabled'),
                      i[0].setAttribute('aria-disabled', 'true'))
                    : (this.removeClass(i[0], this.className + '__month-button--disabled'),
                      i[0].setAttribute('aria-disabled', 'false')),
                this.isMonthOutOfRange(this.getNextMonth(this.month2))
                    ? (this.addClass(a[1], this.className + '__month-button--disabled'),
                      a[1].setAttribute('aria-disabled', 'true'))
                    : (this.removeClass(a[1], this.className + '__month-button--disabled'),
                      a[1].setAttribute('aria-disabled', 'false')))
        }
        topBarDefaultText() {
        ...
        topBarErrorText(t, e, s) {
            ...
            ;(this.addClass(t, this.className + '__info--error'),
                ...
                s > 1
                    ? ((e = (e = this.lang(e + '-plural')).replace('%d', s)), (t.textContent = e))
                    : (e = this.lang(e)))
            this.datepicker.getElementsByClassName(
                this.className + '__info--selected'
            )[0].style.display = 'none'
        ...
        updateSelectableRange() {
                ...
                if (
                    ...
                    if (
                        ...
                        (this.hasClass(t[s], this.className + '__month-day--valid') ||
                            ...
                            this.hasClass(
                                t[s],
                                this.className + '__month-day--before-disabled-date'
                            ))
                    ) {
            ...
            return (this.setDayAriaAttributes(), !0)
        }
        dayHovering(t) {
            ...
            if (!this.hasClass(t, this.className + '__month-day--invalid')) {
                ...
                for (let s = 0; s < t.length; s++) {
                    ...
                    ;(a === e
                        ...
                        this.start &&
                        !this.end &&
                        ((this.start < a && e >= a) || (this.start > a && e <= a))
                            ? this.addClass(t[s], this.className + '__month-day--hovering')
                            : this.removeClass(t[s], this.className + '__month-day--hovering'))
                }
                if (this.start && !this.end) {
                    ...
                    if (this.hoveringTooltip)
                        if ('function' == typeof this.hoveringTooltip)
                            s = this.hoveringTooltip(t, this.start, e)
        ...
        clearDatepicker() {
            ...
            ;((this.datepicker.getElementsByClassName(
                ...
                this.showSelectedDays(),
                this.updateSelectableRange())
            const e = new CustomEvent('afterClear', { bubbles: !0, cancelable: !0 })
        ...
        parseDisabledDates() {
            ...
            for (let e = 0; e < this.disabledDates.length; e++)
                t[e] = s.parse(this.disabledDates[e], 'YYYY-MM-DD')
        ...
        getDisabledDays() {
            ...
            for (let s = 0; s < this.disabledDaysOfWeek.length; s++)
                e.push(t.indexOf(this.disabledDaysOfWeek[s]))
        ...
        setActiveDay(t) {
            ...
            if (
                e &&
                this.hasClass(e, this.className + '__month-day--visibleMonth') &&
                ...
                if (h.length > 0 && i > 0) this.setDayFocus(h[0])
                    ...
                    if (this.goToNextMonth(2, !0)) {
                        ...
                        if (s.length > 0) {
                            if ('down' === t)
                                e = s[0].querySelectorAll(
                                    '.' +
                                        this.className +
                                        '__month-day--visibleMonth[d="' +
                                        a +
                                        '"]'
                                )
                            else if ('last' === t) {
                                ...
                                e = s[0].querySelectorAll(
                                    '.' + this.className + '__month-day--visibleMonth'
                                )
